...
import nwlLogo from '../assets/nlw-logo.svg'
  ...
  return (
    <main className="grid h-screen grid-cols-2">
      ...
      <section className="itens-start relative flex flex-col justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
        ...
        {/* User Signin */}
        <a className="itens-center flex cursor-pointer gap-3 text-left transition-colors hover:text-gray-50">
        ...
        <div className="space-y-5">
          <Image src={nwlLogo} alt="NLW SpaceTime logo" />
